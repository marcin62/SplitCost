                              ...
                              children: [
                                ...
                                Spacer(),
                                 Container( 
                                    width: 115,
                                  child: TextFormField(
                                    decoration: MyDecoration.textInputDecoration.copyWith(hintText: '0%',hintStyle: TextStyle(color: Theme.of(context).hintColor, fontSize: 17),fillColor: Theme.of(context).accentColor,
                                      suffixIcon: Padding(
